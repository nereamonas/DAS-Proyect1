...
public class WidgetRutinasConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            saveDayPref(context, mAppWidgetId, dias); //Guardamos los dias q queremos mostrar las rutinas en preferencias
    ...
    static void deleteTitlePref(Context context, int appWidgetId) { //Cuandos e quiera eliminar
        SharedPreferences.Editor prefs = context.getSharedPreferences(PREFS_NAME, 0).edit();
    ...
    public void onCreate(Bundle icicle) {
        ...
        RadioGroup radioGroup = (RadioGroup) findViewById(R.id.group); //El radio button para elegir los dias
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                // find which radio button is selected
                if(checkedId == R.id.radioButton1) { //Queremos solo del dia actual
                    dias=1;
                } else if(checkedId == R.id.radioButton2) { //Queremos ver las rut de los ultimos dos dias
                    dias=2;
                } else if(checkedId == R.id.radioButton3){//Ultimos 3 dias
                    dias=3;
                }
            }
